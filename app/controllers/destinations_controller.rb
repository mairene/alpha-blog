class DestinationsController < ApplicationController
  ...
  def create
    ...
    @destination.country_code = @country_hash[destination_params[:title].to_sym]
    if @destination.save
  ...
  private
    ...
    def destination_params
      params.require(:destination).permit(:title, :address, :current, :latitutde, :longitude, :country_id, :country_code)
    end
